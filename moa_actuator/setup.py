"""Simulation setup utilities (magnetostatic, transient, parametric sweep)."""
...
@dataclass
class SweepSettings:
    """Parametric sweep settings for actuator workflows."""
...
def create_magnetostatic_setup(m2d, setup_name: str = "MySetup"):
    """Create a magnetostatic analysis setup."""
...
def add_parametric_sweep(m2d, sweep: SweepSettings):
    """Add a parametric sweep over amplitude and displacement."""
...
def assign_mesh_for_transient(m2d):
    """Assign mesh length constraints for transient analysis."""
...
def create_transient_setup(m2d, setup_name: str = "Transient_Setup1"):
    """Create a transient analysis setup."""
    try:
