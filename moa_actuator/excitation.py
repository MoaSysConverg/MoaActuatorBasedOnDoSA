"""Excitation assignment utilities for Maxwell simulations.

Handles boundary conditions, current sources, coils, windings,
...
def assign_force(m2d, anchor_name: str = "Anchor"):
    """Assign force calculation to the moving part."""
