...
- 본 패키지는 **GNU General Public License v3.0 (GPL v3)** 라이선스 하에 배포 및 수정이 가능합니다. 상세 내용은 [LICENSE](LICENSE) 파일을 참조하십시오.
- **면책 고지**: 본 소프트웨어는 모아소프트 교육 및 기술 실습 지원용 샘플로 작성되었습니다. 본 코드를 실제 상용 설계, 제품 개발 및 시뮬레이션에 적용하여 발생하는 결과의 신뢰성, 시스템 영향, 기타 지식재산권 분쟁 등 모든 법적·기술적 책임은 사용자 본인에게 있으며, 개발자 및 모아소프트는 어떠한 민형사상 책임도 지지 않습니다.
